...
const COLLECTIONS := [
	{"id": "beach", "name": "Beach Day", "icon": "🏖️", "diff": "Easy", "weight": 230,
	 "reward_spins": 60,
	 "items": [["🐚", "Seashell", 1], ["🦀", "Crab", 1], ["⛱️", "Umbrella", 1], ["🍦", "Ice Cream", 2], ["🕶️", "Shades", 2], ["🩴", "Flip-Flops", 2], ["🏄", "Surfboard", 3], ["🏐", "Beach Ball", 3], ["🌅", "Golden Sunset", 5]]},
	{"id": "fruits", "name": "Fruit Basket", "icon": "🧺", "diff": "Easy", "weight": 190,
	 "reward_spins": 100,
	 "items": [["🍎", "Apple", 1], ["🍌", "Banana", 1], ["🍇", "Grapes", 2], ["🍉", "Watermelon", 2], ["🍓", "Strawberry", 2], ["🍍", "Pineapple", 3], ["🥝", "Kiwi", 3], ["🥭", "Mango", 4], ["🍋", "Golden Lemon", 5]]},
	{"id": "kitchen", "name": "Island Kitchen", "icon": "🍳", "diff": "Easy", "weight": 155,
	 "reward_spins": 120,
	 "items": [["🥄", "Wooden Spoon", 1], ["🧂", "Sea Salt", 1], ["🍞", "Flatbread", 1], ["🍯", "Wild Honey", 2], ["🫘", "Cocoa Beans", 2], ["🥘", "Fish Stew", 2], ["🍥", "Spiced Cake", 3], ["🍹", "Sunset Punch", 3], ["🍲", "Feast Pot", 5]]},
	{"id": "jungle", "name": "Jungle Trail", "icon": "🌴", "diff": "Easy", "weight": 125,
	 "reward_spins": 150,
	 "items": [["🍃", "Palm Frond", 1], ["🐛", "Beetle", 1], ["🦋", "Butterfly", 2], ["🐸", "Tree Frog", 2], ["🐒", "Monkey", 2], ["🌺", "Hibiscus", 3], ["🦥", "Sloth", 3], ["🦜", "Macaw", 4], ["🐅", "Jungle Tiger", 5]]},
	{"id": "fishing", "name": "Fishing Trip", "icon": "🎣", "diff": "Easy", "weight": 100,
	 "reward_spins": 180,
	 "items": [["🪱", "Bait Fly", 1], ["🪣", "Bucket", 1], ["🐟", "Small Fry", 2], ["🐚", "Net Float", 2], ["🦀", "Pot Catch", 2], ["🦑", "Squid", 3], ["🐬", "Lucky Dolphin", 3], ["🐠", "Rainbow Fish", 4], ["🏆", "Record Catch", 5]]},
	{"id": "pirate", "name": "Pirate Treasure", "icon": "🏴‍☠️", "diff": "Medium", "weight": 60,
	 "reward_spins": 250,
	 "items": [["🗺️", "Old Map", 2], ["🧭", "Compass", 2], ["⚓", "Anchor", 3], ["🦜", "Parrot", 3], ["🗡️", "Cutlass", 3], ["🛢️", "Rum Barrel", 4], ["☠️", "Jolly Roger", 4], ["💰", "Gold Hoard", 5], ["🚢", "Ghost Ship", 5]]},
	{"id": "ocean", "name": "Ocean Life", "icon": "🌊", "diff": "Medium", "weight": 40,
	 "reward_spins": 400,
	 "items": [["🐠", "Reef Fish", 2], ["🪸", "Coral", 3], ["🐙", "Octopus", 3], ["🐢", "Turtle", 3], ["🐬", "Dolphin", 4], ["🦞", "Lobster", 4], ["🦈", "Shark", 4], ["🐳", "Whale", 5], ["🧜", "Mermaid", 5]]},
	{"id": "storm", "name": "Storm Season", "icon": "⛈️", "diff": "Medium", "weight": 30,
	 "reward_spins": 500,
	 "items": [["💧", "Raindrop", 2], ["🌫️", "Sea Fog", 3], ["🌬️", "Squall", 3], ["☂️", "Torn Umbrella", 3], ["🌊", "Rogue Wave", 4], ["⚡", "Lightning", 4], ["🌪️", "Cyclone", 4], ["🌈", "Storm's End", 5], ["☄️", "Falling Star", 5]]},
	{"id": "shipyard", "name": "Shipwright's Yard", "icon": "🛠️", "diff": "Medium", "weight": 24,
	 "reward_spins": 650,
	 "items": [["🪚", "Hand Saw", 2], ["🔨", "Caulking Mallet", 3], ["🔩", "Brass Bolt", 3], ["🪵", "Keel Timber", 3], ["⛓️", "Anchor Chain", 4], ["🧵", "Rigging Rope", 4], ["⚙️", "Capstan Gear", 4], ["⛵", "New Sloop", 5], ["🗼", "Harbour Light", 5]]},
	{"id": "market", "name": "Night Market", "icon": "🏮", "diff": "Medium", "weight": 18,
	 "reward_spins": 800,
	 "items": [["🪙", "Trade Coin", 2], ["🧄", "Garlic Braid", 3], ["🌶️", "Chilli String", 3], ["🫙", "Spice Jar", 3], ["🧶", "Dyed Yarn", 4], ["⚖️", "Merchant Scales", 4], ["🎴", "Card Sharp", 4], ["🪔", "Paper Lantern", 5], ["🧞", "Market Djinn", 5]]},
	...
	{"id": "charts", "name": "Star Charts", "icon": "🔭", "diff": "Hard", "weight": 7,
	 "reward_spins": 1200,
	 "items": [["📐", "Dividers", 3], ["🗞️", "Almanac", 4], ["🌌", "Milky Way", 4], ["🔭", "Spyglass", 4], ["⌛", "Sand Glass", 4], ["🌓", "Half Moon", 5], ["☀️", "Sun Sight", 5], ["🌠", "Guiding Star", 5], ["🌍", "Whole World", 5]]},
	{"id": "volcano", "name": "Volcano Deep", "icon": "🌋", "diff": "Hard", "weight": 6,
	 "reward_spins": 1500,
	 "items": [["🪨", "Obsidian Shard", 3], ["🔥", "Ember", 4], ["🌫️", "Ash Cloud", 4], ["🪨", "Basalt Column", 4], ["⛏️", "Ore Pick", 4], ["💎", "Fire Opal", 5], ["🌋", "Caldera", 5], ["🐉", "Ash Dragon", 5], ["🗝️", "Molten Key", 5]]},
	{"id": "kraken", "name": "Kraken's Hoard", "icon": "🦑", "diff": "Hard", "weight": 3,
	 "reward_spins": 1800,
	 "items": [["🪸", "Black Coral", 4], ["🦴", "Whale Bone", 4], ["🕶️", "Drowned Spyglass", 4], ["⚙️", "Barnacle Cog", 4], ["🗝️", "Rusted Key", 5], ["🏺", "Sealed Jar", 5], ["💍", "Siren's Ring", 5], ["🐡", "Abyss Fish", 5], ["🦑", "The Kraken", 5]]},
	{"id": "royal", "name": "Royal Jewels", "icon": "👑", "diff": "Hard", "weight": 3,
	 "reward_spins": 2000,
