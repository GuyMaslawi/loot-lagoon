...
var export_plugin: AuthReturnExportPlugin


func _enter_tree() -> void:
	export_plugin = AuthReturnExportPlugin.new()
...
class AuthReturnExportPlugin extends EditorExportPlugin:
	var _plugin_name := "AuthReturnAndroid"
